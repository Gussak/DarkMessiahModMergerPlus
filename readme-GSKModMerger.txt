...
Main idea is no free powers for the challenge.  
As I found no way to spend mana, all costs goes to HP thru `hurtme` cmd.    
You have to roleplay a highly challenging scenario, because you end up with access to full developer commands that have no implementable conditional tests nor restrictions, so if you can't hold yourself about cheating, do not use this mod.    
